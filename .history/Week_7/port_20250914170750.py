...
class Lorry(DeliveryApproach):
    def deliver(self,goods:Goods):
        print("Delivering by Lorry")

    def can_handle_goods(self, goods: 'Goods'):
        return goods.goods_type in (GoodsType.CONTAINER, GoodsType.GENERAL)
...
class Train(DeliveryApproach):
    ...
    def can_handle_goods(self, goods: 'Goods'):
        return goods.goods_type in (GoodsType.DANGEROUS, GoodsType.CONTAINER, GoodsType.GENERAL, GoodsType.DANGEROUS)
...
class Ferry(DeliveryApproach):
    ...
    def can_handle_goods(self, goods:Goods):
        return goods.goods_type in  (GoodsType.DANGEROUS, GoodsType.CONTAINER, GoodsType.GENERAL,GoodsType.REFRIGERATED,GoodsType.DANGEROUS)
